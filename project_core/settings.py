...
from project_core.secrets import DATABASE_PASSWORD, EMAIL_ADDRESS, EMAIL_PASSWORD, HOST_EMAIL, PORT_EMAIL
...
SECRET_KEY = 'django-insecure-)%222i2#z%3f=l^+@kcmjeotfz=7#_7lmnl-@t+20e&$1gxixb'
...
DATABASES = {
    'default': {
        ...
        'PASSWORD': DATABASE_PASSWORD,  # <-- PUT YOUR ROOT PASSWORD HERE
